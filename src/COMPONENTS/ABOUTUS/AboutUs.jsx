    ...
    return (
        <>
            <div className='aboutus'>
                ...
                <h2>Our Vision</h2>
                <p>We envision a world where technology bridges the gap between individuals and preventive healthcare. By providing accessible tools for early risk detection, we aim to reduce the global burden of heart diseases and save countless lives.</p>
                <h2>Why Choose Us</h2>
                <ul>
                ...
                <p>Your health is our priority. Whether you’re looking to take proactive steps in managing your heart health or seeking to understand your risks better, we’re here to guide you every step of the way.
